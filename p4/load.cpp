...
//Tokenizer class to abstract words from file
class Tokenizer	{
	string source;
	char delim;
...
int main(int argc, const char* argv[]){
	...
	if(rc){
		...
		ifstream in_file("Pop_Estimate_Dataset/Sumlev.txt");
	...
	if(rc){
		...
		ifstream in_file("Pop_Estimate_Dataset/Sex.txt");
		sqlite3_exec(db, "BEGIN TRANSACTION", NULL, NULL, &error);
		int linecount =0;
		string stream;
		while (getline(in_file, line)){
	...
	if(rc){
		...
		ifstream in_file("Pop_Estimate_Dataset/Race.txt");
		sqlite3_exec(db, "BEGIN TRANSACTION", NULL, NULL, &error);
		int linecount =0;
		string stream;
		while (getline(in_file, line)){
	...
	if(rc){
		...
		ifstream in_file("Pop_Estimate_Dataset/Region.txt");
		sqlite3_exec(db, "BEGIN TRANSACTION", NULL, NULL, &error);
		int linecount =0;
		string stream;
		while (getline(in_file, line)){
	...
	if(rc){
		...
		ifstream in_file("Pop_Estimate_Dataset/Division.txt");
		sqlite3_exec(db, "BEGIN TRANSACTION", NULL, NULL, &error);
		int linecount =0;
		string stream;
		while (getline(in_file, line)){
	...
	if(rc){
		...
		ifstream in_file("Pop_Estimate_Dataset/Origin.txt");
		sqlite3_exec(db, "BEGIN TRANSACTION", NULL, NULL, &error);
		int linecount =0;
		string stream;
		while (getline(in_file, line)){
	...
	if(rc){
		...
		ifstream in_file("Pop_Estimate_Dataset/Housing_Units_State_Level.txt");
		sqlite3_exec(db, "BEGIN TRANSACTION", NULL, NULL, &error);
		int linecount =0;
		string stream;
		while (getline(in_file, line)){
	...
	if(rc){
		...
		ifstream in_file("Pop_Estimate_Dataset/Pop_Estimate_Metro_Micro.txt");
		sqlite3_exec(db, "BEGIN TRANSACTION", NULL, NULL, &error);
		int linecount =0;
		string stream;
		while (getline(in_file, line)){
	...
	if(rc){
		...
		ifstream in_file("Pop_Estimate_Dataset/Pop_Estimate_PR_Mun_Sex_Age.txt");
		sqlite3_exec(db, "BEGIN TRANSACTION", NULL, NULL, &error);
		int linecount =0;
		string stream;
		while (getline(in_file, line)){
	...
	if(rc){
		...
		ifstream in_file("Pop_Estimate_Dataset/Pop_Estimate_PR_Municipios.txt");
		sqlite3_exec(db, "BEGIN TRANSACTION", NULL, NULL, &error);
		int linecount =0;
		string stream;
		while (getline(in_file, line)){
	...
	if(rc){
		...
		ifstream in_file("Pop_Estimate_Dataset/Pop_Estimate_PR_Sex_Age.txt");
		sqlite3_exec(db, "BEGIN TRANSACTION", NULL, NULL, &error);
		int linecount =0;
		string stream;
		while (getline(in_file, line)){
	...
	if(rc){
		...
		ifstream in_file("Pop_Estimate_Dataset/Pop_Estimate_State_Age_Sex_Race_Origin.txt");
		sqlite3_exec(db, "BEGIN TRANSACTION", NULL, NULL, &error);
		int linecount =0;
		string stream;
		while (getline(in_file, line)){
	...
	if(rc){
		...
		ifstream in_file("Pop_Estimate_Dataset/Pop_Estimate_Cities_Towns.txt");
		sqlite3_exec(db, "BEGIN TRANSACTION", NULL, NULL, &error);
		int linecount =0;
		string stream;
		while (getline(in_file, line)){
	...
	if(rc){
		...
		ifstream in_file("Pop_Estimate_Dataset/Pop_Estimate_State_County.txt");
		sqlite3_exec(db, "BEGIN TRANSACTION", NULL, NULL, &error);
		int linecount =0;
		string stream;
		while (getline(in_file, line)){
	...
	if(rc){
		...
		ifstream in_file("Pop_Estimate_Dataset/Pop_Estimate_Nation_State_PR.txt");
		int linecount = 0;
		string stream;
		while(getline(in_file, line)){
			if(linecount==0){
